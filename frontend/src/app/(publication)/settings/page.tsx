      ...
      <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6">
        ...
        <Card className="mb-6 p-6">
          <div className="mb-6">
            ...
            <div className="mt-3 flex items-center gap-4">
              ...
              <label
                className={`cursor-pointer rounded-lg border border-border px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-muted ${avatarUploading ? 'cursor-not-allowed opacity-50' : ''}`}
              >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Nama yang ditampilkan di komentar dan profil.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="flex items-center justify-between">
                      <FormDescription>Maks 160 karakter.</FormDescription>
        ...
        <Card className="mb-6 p-6">
          ...
          <p className="mb-6 text-sm text-muted-foreground">
            Ganti kata sandi kamu. Kamu akan tetap masuk setelah berhasil.
          </p>
