...
export default function AdminForgotPasswordPage() {
  ...
  async function onSubmit(values: FormValues) {
    try {
      await apiClient.post('/auth/admin/forgot-password', { email: values.email });
    } catch {
    ...
    <AuthShell
      ...
      subtitle={
        sent
          ...
          : 'Masukkan email admin platform, kami akan kirim tautan reset.'
      }
      footer={
        <Link href="/admin/login" className="inline-flex items-center gap-1.5 hover:text-foreground">
